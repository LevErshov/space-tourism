...
window.onload =function () {
    const headerElement = document.querySelector('.header__header');
    ...
    const menuListAll = document.querySelector('.menu__list');
    ...
    if (innerWidth < 992) {
        ...
        menuItem.forEach(e => {
            e.addEventListener("click", function () {
                menuListAll.classList.remove('_active');
                iconMenu.classList.remove('_active');
                isBody.classList.remove('_lock')
            })
        });
    }
}
...
let firstSlider = new Swiper('.slider__body', {
	/*
	effect: 'fade',
	autoplay: {
		delay: 3000,
